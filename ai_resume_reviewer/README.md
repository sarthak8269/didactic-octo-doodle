...
An AI-powered resume analyzer built with **Flask**, **HTML**, and **Tailwind CSS**. This tool allows users to upload a PDF resume, receive a smart AI-generated summary, and get insights into how well the resume performs against typical **ATS (Applicant Tracking System)** filters using OpenAI's GPT model.
...
- ✨ Generate a professional summary using OpenAI
- ✅ Receive ATS optimization tips and keyword analysis
